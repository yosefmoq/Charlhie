...
import com.yosefmoq.charlhie.utils.CommonUtils;
import com.yosefmoq.charlhie.utils.NetworkUtils;
import com.yosefmoq.charlhie.utils.Validator;
...
public abstract class BaseActivity<T extends ViewDataBinding, V extends BaseViewModel> extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getViewModel().errorResLiveData.observe(this, new Observer<ErrorResponse>() {
            @Override
            public void onChanged(ErrorResponse errorResponse) {
                showError(getViewModel().getErrorMMessages(errorResponse));
            }
        });
    ...
    protected void consumeResponse(Object o) {
